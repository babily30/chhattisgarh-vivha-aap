...
class PrimeGold extends StatefulWidget {
  const PrimeGold({super.key});

  @override
  State<PrimeGold> createState() => _PrimeGoldState();
}
...
class _PrimeGoldState extends State<PrimeGold> {
  @override
              ...
              children: [
                Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text('View 100 Contact Nos',style: TextStyle(fontSize: 20,fontFamily:'CustomSans',color: const Color.fromARGB(255, 143, 139, 139))
                    ),
                  ],
                ),
                SizedBox(height: 20),
